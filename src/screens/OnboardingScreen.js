  ...
  return (
    ...
    <StatusBar style="auto" />
      ...
      <View >
        ...
        <Text style={styles.titleDescription}>Manage all your crypto assets! It's Simple and easy! </Text>
        <View style={styles.bottonContainer}>

          
            
            <Text style={styles.skip} >Skip</Text>
            <Text style={styles.next} onPress={() => navigation.navigate("OnboardingScreenTwo")} >Next</Text>
        </View>
      </View>
